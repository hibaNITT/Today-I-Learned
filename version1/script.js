// without jquery
// const btn = document.querySelector(".btn-shareFact");
// btn.addEventListener("click", function () {
//   $(".fact-form").toggleClass("hidden");
// });

// arrow function

// const calcFact = (parameter) => 2025 - year;
// console.log(calcFact(year));

// arrays

// if fact is an array of 3 elements and you want to
// make an array of 4 elements,
// const newFact = [...fact,"hi"] - SPREADING
//... spread operator
...
// const c =  array.map((el) => el * 10);

//console.log(fact.join("separator"));

//******************************************************************

//EACH HTML ELEMENT IS A JS DOM OBJECT
